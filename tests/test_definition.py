...
class TestTriggerDefinition(unittest.TestCase):
    ...
    def test_match_for_criteria(self):
        ...
        self.assertTrue(tdef.match(event1, self.fake_debugger))
        self.assertFalse(tdef.match(event2, self.fake_debugger))
        config = dict(name='test_trigger',
                 expiration='$last + 1d',
                 fire_pipeline='test_pipeline',
                 fire_criteria=[dict(event_type='test.thing')],
        ...
        tdef = definition.TriggerDefinition(config)
        self.assertTrue(tdef.match(event1, self.fake_debugger))
        self.assertTrue(tdef.match(event2, self.fake_debugger))
    ...
    def test_get_distinguished_traits(self):
        ...
        event1 = dict(event_type='test.thing', instance_id='foo')
        tdef = definition.TriggerDefinition(config)
        mcriteria = tdef.match(event1, self.fake_debugger)
    ...
    def test_should_fire(self):
        ...
        self.assertTrue(tdef.should_fire(events1, self.fake_debugger))
        self.assertTrue(tdef.should_fire(events2, self.fake_debugger))
        self.assertFalse(tdef.should_fire(events3, self.fake_debugger))
        config = dict(name='test_trigger',
                 expiration='$last + 1d',
                 distinguished_by=['instance_id'],
                 fire_pipeline='test_pipeline',
        ...
        tdef = definition.TriggerDefinition(config)
        self.assertTrue(tdef.should_fire(events1, self.fake_debugger))
        self.assertFalse(tdef.should_fire(events2, self.fake_debugger))
        self.assertFalse(tdef.should_fire(events3, self.fake_debugger))
